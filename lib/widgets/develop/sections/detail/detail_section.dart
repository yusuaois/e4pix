...
class _DetailSectionState extends State<DetailSection> {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ..._buildSharpenSliders(p),
          ..._buildDenoiseSliders(p),
          const SectionLabel(title: 'Grain'),
          _grainSliders(p, g, setGrain),
        ],
      ),
    );
  }

  List<Widget> _buildSharpenSliders(AdjustmentParams p) {
    return [
  ...
  List<Widget> _buildDenoiseSliders(AdjustmentParams p) {
    return [
  ...
  // ── Grain sliders extracted for readability ──

  Widget _grainSliders(
    AdjustmentParams p,
    GrainParams g,
    void Function(GrainParams) setGrain,
  ) {
    final advancedChildren = <Widget>[
      ...
      DevelopSliderTile(
        ...
        max: 255,
        resetValue: 170,
        onChanged: (v) => setGrain(g.copyWith(highlightThreshold: v)),
      ),
      DevelopSliderTile(
      ...
      DevelopSliderTile(
        ...
        fractionDigits: 2,
        resetValue: 0.3,
        onChanged: (v) => setGrain(g.copyWith(highlightStrength: v)),
      ),
      DevelopSliderTile(
      ...
      DevelopSliderTile(
        ...
        fractionDigits: 2,
        resetValue: 0.95,
        onChanged: (v) => setGrain(g.copyWith(colorPreservation: v)),
      ),
    ];
