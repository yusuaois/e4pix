...
class ImageInfoBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (isPhone) return _buildPhone(context, ref, image, isLoading, path, m, active);
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (image != null) RatingFlagBar(key: ValueKey('phone_${active?.rating}_${active?.flag}')),
        ],
      ),
    );
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          RatingFlagBar(key: ValueKey('desktop_${active?.rating}_${active?.flag}')),
