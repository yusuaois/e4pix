...
class SpongeSection extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          const SectionLabel(title: 'sponge'),
          _buildActivationHeader(ref),
          if (isActive) _buildActiveControls(ref),
  ...
  Widget _buildActivationHeader(WidgetRef ref) {
    final state = ref.watch(spongeStateProvider);
  ...
  Widget _buildActiveControls(WidgetRef ref) {
    final state = ref.watch(spongeStateProvider);
    final notifier = ref.read(spongeStateProvider.notifier);
